...
**Returns:** `SearchStrategy[coordinaxs.astro.DistanceModulus]`
...
**Returns:** `SearchStrategy[coordinaxs.astro.Parallax]`
...
`coordinaxs.hypothesis` is licensed under the MIT License. See the LICENSE file for details.
