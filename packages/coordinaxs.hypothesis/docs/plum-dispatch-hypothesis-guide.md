...
The patterns here are taken from integration coverage in `packages/coordinaxs.hypothesis/tests/test_composite_dispatch.py`.
...
- Integration tests that validate these patterns: `packages/coordinaxs.hypothesis/tests/test_composite_dispatch.py`
