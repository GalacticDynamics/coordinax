...
>>> op = cxfm.TimeDep(cxfc.BishopBuilder(circle, "s", normal_0="auto"))
...
>>> chart = cxfc.TubularChart(cxfc.BishopBuilder(circle, "s", normal_0="auto"), tau_bounds=BOUNDS)
...
```{code-block} python
>>> ch_bishop = cxfc.TubularChart(cxfc.BishopBuilder(circle, "s", normal_0="auto"), tau_bounds=BOUNDS)
...
...     cxfc.BishopBuilder(stretching, "km", station=u.Q(1.3, "km"), normal_0="auto"),
...
...     return cxfc.TubularChart(cxfc.BishopBuilder(curve, "s", normal_0="auto"), tau_bounds=HELIX_BOUNDS)
...
>>> ch_b = cxfc.TubularChart(cxfc.BishopBuilder(helix, "s", normal_0="auto"), tau_bounds=HELIX_BOUNDS)
...
...     cxfc.BishopBuilder(arc, "km", normal_0="auto"), tau_bounds=(u.Q(0.0, "km"), u.Q(5.0, "km"))
... )
...
>>> worldtube = cxfc.BishopBuilder(stretching, "km", station=u.Q(1.3, "km"), normal_0="auto")
...
```{code-block} python
>>> slice_ = cxfc.BishopBuilder(cxfc.AtTime(stretching, u.Q(1.0, "s")), "km", normal_0="auto")
...
...     cxfc.BishopBuilder(cxfc.AtTime(stretching, t), "km", normal_0="auto"),
...
`normal_0`. When the tangent rotates with time the labels name a
...
...     cxfc.BishopBuilder(arclen_circle, "km", normal_0="auto"), tau_bounds=(u.Q(0.0, "km"), u.Q(4 * jnp.pi, "km"))
... )
...
...     cxfc.BishopBuilder(cxfc.AtTime(slice_series, u.Q(0.0, "s")), "km", normal_0="auto"),
...
...     cxfc.BishopBuilder(cxfc.AtTime(stitched_blend, u.Q(0.5, "s")), "km", normal_0="auto"),
...
...     cxfc.BishopBuilder(cxfc.AtTime(arc_blend, u.Q(0.5, "s")), "km", normal_0="auto"),
...     tau_bounds=(u.Q(0.0, "km"), u.Q(20.0, "km")),
... )
...
```{code-block} python
>>> wide = cxfc.TubularChart(cxfc.BishopBuilder(circle, "s", normal_0="auto"), tau_bounds=(u.Q(0.0, "s"), u.Q(4 * jnp.pi, "s")))
...
>>> knot = cxfc.TubularChart(cxfc.BishopBuilder(trefoil, "s", normal_0="auto"), tau_bounds=BOUNDS)
...
...     cxfc.BishopBuilder(spun_rod, "km", station=u.Q(1.3, "km"), normal_0="auto"),
...     tau_bounds=(u.Q(0.0, "s"), u.Q(2.0, "s")),
... )
