...
def test_the_chart_round_trips_over_an_arc_length_curve(build_frame) -> None:
    ch = _chart(cxfc.BishopBuilder, build_frame)
...
def test_unit_speed_collapses_g_ss_to_the_textbook_form(build_frame) -> None:
