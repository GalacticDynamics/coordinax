...
@given(chain=cxst.chart_time_chain(cx.roles.PhysVel, cx.charts.cart3d))
@settings(max_examples=30)
...
@given(
    chain=cxst.chart_time_chain(
        cx.roles.PhysDisp, cxst.charts(filter=cx.charts.Abstract3D)
    )
)
@settings(max_examples=30)
...
@given(
    chain=cxst.chart_time_chain(
        cx.roles.PhysVel, cxst.charts(filter=cx.charts.Abstract3D)
    )
)
@settings(max_examples=30)
...
@given(
    chain=cxst.chart_time_chain(
        cx.roles.PhysAcc, cxst.charts(filter=cx.charts.Abstract3D)
    )
)
@settings(max_examples=30)
...
@given(
    chain=cxst.chart_time_chain(
        cx.roles.PhysAcc, cxst.charts(filter=cx.charts.Abstract2D)
    )
)
@settings(max_examples=30)
