...
@given(chain=cxst.chart_time_chain(cxr.phys_vel, cxc.cart3d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_vel, cxc.polar2d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_vel, cxc.radial1d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_acc, cxc.cart3d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_acc, cxc.sph3d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_acc, cxc.radial1d))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.point, cxst.charts(filter=cxc.Abstract3D)))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_vel, cxst.charts(filter=cxc.Abstract3D)))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_acc, cxst.charts(filter=cxc.Abstract3D)))
@settings(max_examples=30)
...
@given(chain=cxst.chart_time_chain(cxr.phys_acc, cxst.charts(filter=cxc.Abstract2D)))
@settings(max_examples=30)
