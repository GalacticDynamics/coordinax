...
`coordinaxs.api` exposes abstract multiple-dispatch functions that you extend in your own package.
...
Register a minimal implementation in your own package, then call it through the `coordinaxs.api` namespace:
