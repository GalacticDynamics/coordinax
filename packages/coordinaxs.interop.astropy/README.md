...
This package provides converters and constructors to seamlessly work with Astropy coordinate representations, differentials, frames, and quantities.
...
- **Frame Conversions**: Convert between coordinaxs.astro frames (`ICRS`, `Galactocentric`) and Astropy coordinate frames
