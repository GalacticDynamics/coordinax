...
def frame_transform_op(
    ...
    """
    return (
        cxapi.frame_transform_op(from_frame, to_frame.base_frame) | to_frame.xop.inverse
    )
...
def frame_transform_op(
    ...
    """
    return from_frame.xop | cxapi.frame_transform_op(from_frame.base_frame, to_frame)
...
def frame_transform_op(
    ...
    return (
        from_frame.xop
        | cxapi.frame_transform_op(from_frame.base_frame, to_frame.base_frame)
