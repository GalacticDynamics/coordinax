...
__all__ = ("AbstractEmbedded", "EmbeddedManifold")
...
def embed_tangent(
    ...
    *,
    ...
    >>> import coordinax.embeddings as cxe
    >>> import unxt as u
    >>> rep = cxe.EmbeddedManifold(cxc.twosphere, cxc.cart3d,
    ...                            params={"R": u.Q(1.0, "km")})
    >>> p = {"theta": u.Angle(jnp.pi / 2, "rad"), "phi": u.Angle(0.0, "rad")}
...
def project_tangent(
    ...
    *,
    ...
    """
    p_pos_ambient = cxapi.embed_point(embedded, at, usys=usys)
    return cxapi.physical_tangent_transform(
