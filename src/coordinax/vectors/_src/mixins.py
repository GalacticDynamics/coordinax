...
__all__: tuple[str, ...] = ("AstropyRepresentationAPIMixin",)
...
class AstropyRepresentationAPIMixin:
    ...
    def represent_as(self, target: Any, *args: Any, **kwargs: Any) -> Any:
        ...
        Parameters
        ----------
        target : type[`coordinax.vectors.Point`]
            The representation type to convert to, e.g. `cxc.sph3d`.
        *args, **kwargs
            Extra arguments. These are passed to `coordinax.cconvert` and might
        ...
        """
        return cxr.cconvert(self, target, *args, **kwargs)
