...
class AbstractCoordinate(AbstractVector):
    ...
    #: The reference frame of the coordinate.
    frame: AbstractReferenceFrame = eqx.field(converter=AbstractReferenceFrame.from_)
...
def _add_coord_coord(w1: Coordinate, w2: Coordinate, /) -> Coordinate:
    """Add two coordinates."""
