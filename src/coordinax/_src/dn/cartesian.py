...
@CartesianPosND.constructor._f.dispatch  # type: ignore[attr-defined,misc]  # noqa: SLF001
def constructor(
    ...
    >>> cx.CartesianPosND.constructor(Quantity(1, "kpc"))
    CartesianPosND(
    ...
    >>> cx.CartesianPosND.constructor(Quantity([1, 2], "kpc"))
    CartesianPosND(
    ...
    >>> cx.CartesianPosND.constructor(Quantity([1, 2, 3], "kpc"))
    CartesianPosND(
    ...
    >>> cx.CartesianPosND.constructor(Quantity([1, 2, 3, 4], "kpc"))
    CartesianPosND(
...
def _add_vcnd(lhs: CartesianPosND, rhs: AbstractPos, /) -> CartesianPosND:
    ...
    >>> q1 = cx.CartesianPosND.constructor([1, 2, 3], "kpc")
    >>> q2 = cx.CartesianPosND.constructor([2, 3, 4], "kpc")
    >>> (q1 + q2).q
...
# TODO: move to the class in py3.11+
@CartesianVelND.constructor._f.dispatch  # type: ignore[attr-defined,misc]  # noqa: SLF001
def constructor(
    ...
    >>> cx.CartesianVelND.constructor(Quantity(1, "km/s"))
    CartesianVelND(
    ...
    >>> cx.CartesianVelND.constructor(Quantity([1, 2], "km/s"))
    CartesianVelND(
    ...
    >>> cx.CartesianVelND.constructor(Quantity([1, 2, 3], "km/s"))
    CartesianVelND(
    ...
    >>> cx.CartesianVelND.constructor(Quantity([1, 2, 3, 4], "km/s"))
    CartesianVelND(
...
# TODO: move to the class in py3.11+
@CartesianAccND.constructor._f.dispatch  # type: ignore[attr-defined,misc]  # noqa: SLF001
def constructor(
    ...
    >>> cx.CartesianAccND.constructor(Quantity(1, "km/s2"))
    CartesianAccND(
    ...
    >>> cx.CartesianAccND.constructor(Quantity([1, 2], "km/s2"))
    CartesianAccND(
    ...
    >>> cx.CartesianAccND.constructor(Quantity([1, 2, 3], "km/s2"))
    CartesianAccND(
    ...
    >>> cx.CartesianAccND.constructor(Quantity([1, 2, 3, 4], "km/s2"))
    CartesianAccND(
