...
def vector(
    ...
    CartesianPosND(q=Quantity(Array([1, 2], dtype=int32), unit='km'))

    >>> cx.vecs.CartesianVelND.from_(u.Quantity([1, 2], "km/s"))
    CartesianVelND(q=Quantity(Array([1, 2], dtype=int32), unit='km / s'))

    >>> cx.vecs.CartesianAccND.from_(u.Quantity([1, 2], "km/s2"))
    CartesianAccND(q=Quantity(Array([1, 2], dtype=int32), unit='km / s2'))

    3D vector:

    >>> cx.vecs.CartesianPosND.from_(u.Quantity([1, 2, 3], "km"))
    CartesianPosND(q=Quantity(Array([1, 2, 3], dtype=int32), unit='km'))

    >>> cx.vecs.CartesianVelND.from_(u.Quantity([1, 2, 3], "km/s"))
    CartesianVelND(q=Quantity(Array([1, 2, 3], dtype=int32), unit='km / s'))

    >>> cx.vecs.CartesianAccND.from_(u.Quantity([1, 2, 3], "km/s2"))
    CartesianAccND(q=Quantity(Array([1, 2, 3], dtype=int32), unit='km / s2'))

    4D vector:

    >>> cx.vecs.CartesianPosND.from_(u.Quantity([1, 2, 3, 4], "km"))
    CartesianPosND(q=Quantity(Array([1, 2, 3, 4], dtype=int32), unit='km'))

    >>> cx.vecs.CartesianVelND.from_(u.Quantity([1, 2, 3, 4], "km/s"))
    CartesianVelND(q=Quantity(Array([1, 2, 3, 4], dtype=int32), unit='km / s'))

    >>> cx.vecs.CartesianAccND.from_(u.Quantity([1, 2, 3, 4], "km/s2"))
    CartesianAccND(q=Quantity(Array([1, 2, 3, 4], dtype=int32), unit='km / s2'))
