...
@CartesianPos2D.constructor._f.dispatch  # type: ignore[attr-defined, misc] # noqa: SLF001
def constructor(
    ...
    >>> vec = cx.CartesianPos2D.constructor(Quantity([1, 2], "m"))
    >>> vec
    CartesianPos2D(
...
def _add_cart2d_pos(lhs: CartesianPos2D, rhs: AbstractPos, /) -> CartesianPos2D:
    ...
    >>> cart = cx.CartesianPos2D.constructor(Quantity([1, 2], "kpc"))
...
def _mul_v_cart2d(lhs: ArrayLike, rhs: CartesianPos2D, /) -> CartesianPos2D:
    ...
    >>> v = cx.CartesianPos2D.constructor(Quantity([3, 4], "m"))
    >>> jnp.multiply(5, v).x
...
def _neg_p_cart2d_pos(obj: CartesianPos2D, /) -> CartesianPos2D:
    ...
    --------
    >>> import coordinax as cx
    >>> q = cx.CartesianPos2D.constructor([1, 2], "km")
    >>> (-q).x
...
def _sub_cart2d_pos2d(lhs: CartesianPos2D, rhs: AbstractPos, /) -> CartesianPos2D:
    ...
    >>> from unxt import Quantity
    >>> import coordinax as cx
    >>> cart = cx.CartesianPos2D.constructor([1, 2], "kpc")
    >>> polr = cx.PolarPos(r=Quantity(3, "kpc"), phi=Quantity(90, "deg"))
...
@CartesianVel2D.constructor._f.dispatch  # type: ignore[attr-defined, misc] # noqa: SLF001
def constructor(
    ...
    >>> vec = cx.CartesianVel2D.constructor(Quantity([1, 2], "m/s"))
    >>> vec
    CartesianVel2D(
...
def _add_pp(lhs: CartesianVel2D, rhs: CartesianVel2D, /) -> CartesianVel2D:
    ...
    >>> v = cx.CartesianVel2D.constructor(Quantity([1, 2], "km/s"))
    >>> (v + v).d_x
...
def _mul_vp(lhs: ArrayLike, rhts: CartesianVel2D, /) -> CartesianVel2D:
    ...
    >>> v = cx.CartesianVel2D.constructor(Quantity([3, 4], "m/s"))
    >>> (5 * v).d_x
...
class CartesianAcc2D(AvalMixin, AbstractAcc2D):
    ...
    def norm(self, _: AbstractVel2D | None = None, /) -> ct.BatchableAcc:
        ...
        >>> from unxt import Quantity
        >>> import coordinax as cx
        >>> v = cx.CartesianAcc2D.constructor([3, 4], "km/s2")
        >>> v.norm()
...
@CartesianAcc2D.constructor._f.dispatch  # type: ignore[attr-defined, misc]  # noqa: SLF001
def constructor(
    cls: type[CartesianAcc2D],
    ...
    >>> vec = cx.CartesianAcc2D.constructor(Quantity([1, 2], "m/s2"))
    >>> vec
    CartesianAcc2D(
...
def _add_aa(lhs: CartesianAcc2D, rhs: CartesianAcc2D, /) -> CartesianAcc2D:
    ...
    >>> v = cx.CartesianAcc2D.constructor(Quantity([3, 4], "km/s2"))
    >>> (v + v).d2_x
...
def _mul_va(lhs: ArrayLike, rhts: CartesianAcc2D, /) -> CartesianAcc2D:
    ...
    >>> v = cx.CartesianAcc2D.constructor(Quantity([3, 4], "m/s2"))
