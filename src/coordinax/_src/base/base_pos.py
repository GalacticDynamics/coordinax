...
class AbstractPos(AvalMixin, AbstractVector):  # pylint: disable=abstract-method
    ...
    def __eq__(self: "AbstractPos", other: object) -> Any:
        ...
        >>> vec1 = cx.CartesianPos3D.constructor([[1, 2, 3], [1, 2, 4]], "m")
        >>> vec2 = cx.CartesianPos3D.constructor([1, 2, 3], "m")
        >>> jnp.equal(vec1, vec2)
        ...
        >>> vec1 = cx.CartesianPos1D.constructor([1], "m")
        >>> vec2 = cx.RadialPos.constructor([1], "m")
        >>> jnp.equal(vec1, vec2)
        Array(True, dtype=bool)

        >>> vec1 = cx.CartesianPos2D.constructor([2, 0], "m")
    ...
    def norm(self) -> ct.BatchableLength:
        ...
        >>> v = cx.CartesianPos1D.constructor([-1], "kpc")
        >>> v.norm()
        Quantity['length'](Array(1., dtype=float32), unit='kpc')

        >>> v = cx.CartesianPos2D.constructor([3, 4], "kpc")
        >>> v.norm()
        ...
        >>> v = cx.CartesianPos3D.constructor([1, 2, 3], "m")
        >>> v.norm()
