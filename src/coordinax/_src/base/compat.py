...
def convert_pos_to_absquantity(obj: AbstractPos, /) -> AbstractQuantity:
    ...
    >>> pos = cx.CartesianPos1D.constructor([1.0], "km")
    >>> convert(pos, AbstractQuantity)
    Quantity['length'](Array([1.], dtype=float32), unit='km')

    >>> pos = cx.RadialPos.constructor([1.0], "km")
    >>> convert(pos, AbstractQuantity)
    Quantity['length'](Array([1.], dtype=float32), unit='km')

    >>> pos = cx.CartesianPos2D.constructor([1.0, 2.0], "km")
    >>> convert(pos, AbstractQuantity)
    ...
    >>> pos = cx.CartesianPos3D.constructor([1.0, 2.0, 3.0], "km")
    >>> convert(pos, AbstractQuantity)
