...
class AbstractVector(ArrayValue):  # type: ignore[misc]
    ...
    def constructor(
        ...
        >>> vec = cx.CartesianPos3D.constructor(xs)
        >>> vec
        CartesianPos3D(
    ...
    def constructor(
        ...
        >>> vec = cx.CartesianPos3D.constructor([1, 2, 3], "meter")
        >>> vec
        CartesianPos3D(
            x=Quantity[...](value=f32[], unit=Unit("m")),
            y=Quantity[...](value=f32[], unit=Unit("m")),
        ...
        >>> vec = cx.CartesianPos3D.constructor(xs, "meter")
        >>> vec
        CartesianPos3D(
            x=Quantity[...](value=f32[2], unit=Unit("m")),
            y=Quantity[...](value=f32[2], unit=Unit("m")),
    ...
    def ndim(self) -> int:
        ...
        >>> vec = cx.CartesianPos2D.constructor([[1, 2], [3, 4]], "m")
        >>> vec.ndim
        1
    ...
    def __eq__(self: "AbstractVector", other: object) -> Any:
        ...
        Poss are covered by a separate dispatch. So here we show velocities
        and accelerations:
        ...
        >>> vel1 = cx.CartesianVel2D.constructor([[1, 3], [2, 4]], "km/s")
        >>> vel2 = cx.CartesianVel2D.constructor([[1, 3], [0, 4]], "km/s")
        >>> vel1.d_x
        ...
        >>> vel1 = cx.CartesianVel3D.constructor([[1, 4], [2, 5], [3, 6]], "km/s")
        >>> vel2 = cx.CartesianVel3D.constructor([[1, 4], [0, 5], [3, 0]], "km/s")
        >>> vel1.d_x
    ...
    def __abs__(self) -> Quantity:
        ...
        --------
        >>> import coordinax as cx
        >>> vec = cx.CartesianPos2D.constructor([3, 4], "m")
        >>> abs(vec)
    ...
    def __mul__(self: "AbstractVector", other: Any) -> Any:
        ...
        >>> vec = cx.CartesianPos3D.constructor(Quantity([1, 2, 3], "m"))
        >>> (vec * 2).x
    ...
    def sizes(self) -> MappingProxyType[str, int]:
        ...
        >>> cx.CartesianPos2D.constructor([1, 2], "m").sizes
        mappingproxy({'x': 1, 'y': 1})

        >>> cx.CartesianPos2D.constructor([[1, 2], [1, 2]], "m").sizes
    ...
    def to_units(self, usys: Any, /) -> "AbstractVector":
        ...
        >>> vec = cx.CartesianPos3D.constructor([1, 2, 3], "km")
        >>> vec.to_units(usys)
        CartesianPos3D(
            x=Quantity[...](value=f32[], unit=Unit("m")),
            y=Quantity[...](value=f32[], unit=Unit("m")),
...
def constructor(cls: type[AbstractVector], obj: AbstractVector, /) -> AbstractVector:
    ...
    >>> q = cx.CartesianPos3D.constructor([1, 2, 3], "km")

    >>> cart = cx.CartesianPos3D.constructor(q)
    >>> cart
    CartesianPos3D(
      x=Quantity[...](value=f32[], unit=Unit("km")),
      y=Quantity[...](value=f32[], unit=Unit("km")),
    ...
    >>> p = cx.CartesianVel3D.constructor([1, 2, 3], "km/s")

    >>> cart = cx.CartesianVel3D.constructor(p)
