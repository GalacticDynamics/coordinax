...
class FourVector(AbstractPos4D):
    ...
    :meth:`coordinax.CartesianPos3D.constructor` method to create the 3D vector.
    ...
    q: AbstractPos3D = eqx.field(
        converter=Unless(AbstractPos3D, CartesianPos3D.constructor)
    )
    """Spatial coordinates."""
    ...
    @classmethod
    @AbstractPos4D.constructor._f.dispatch  # type: ignore[attr-defined, misc]  # noqa: SLF001
    def constructor(
