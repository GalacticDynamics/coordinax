...
from coordinax._src import api, charts as cxc
from coordinax._src.api import coord_transform
...
def coord_transform(
    ...
    return lambda *args, **kw: api.coord_transform(to_chart, from_chart, *args, **kw)
...
def coord_transform(
    ...
    *,
    ...
    out_parts = tuple(
        api.coord_transform(t, f, x_part, at=at_part, usys=usys)
