...
# =============================================================================
# point_realization_map with product charts


class TestPointTransformProductCharts:
    """Test ``point_realization_map`` works correctly with product charts."""
    ...
    def test_spacetime_ct_cart_to_sph(self) -> None:
        ...
        result = cxc.point_realization_map(st_sph, st_cart, p)
    ...
    def test_namespaced_phase_space_transform(self) -> None:
        """point_realization_map should work with namespaced CartesianProductChart."""
        ...
        result = cxc.point_realization_map(phase_sph, phase_cart, p)
