...
def test_sph2_cartesian_chart_raises() -> None:
    """SphericalTwoSphere does not have a global Cartesian 2D chart."""
    with pytest.raises(
        cxc.NoGlobalCartesianChartError,
        match="SphericalTwoSphere has no global Cartesian 2D",
    ):
        _ = cxc.sph2.cartesian
